...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 6liFua4rlEpKyn/css
import MenuIcon from "./icons/PlasmicIcon__Menu"; // plasmic-import: mPGrEqgSIOU0nv/icon
  ...
  return (
    <p.Stack
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolors_black_showEndIcon_rounded_size_large]:
            hasVariant($state, "showEndIcon", "showEndIcon") &&
            hasVariant($state, "colors", "black") &&
    ...
    >
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__l6K2S, {
            [sty.freeBoxiconOnly__l6K2SA5Xx]: hasVariant(
              $state,
              "iconOnly",
              "iconOnly"
            ),

            [sty.freeBoxshowEndIcon__l6K2SPetz9]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),

            [sty.freeBoxshowStartIcon__l6K2SjS4B0]: hasVariant(
              $state,
              "showStartIcon",
              "showStartIcon"
            ),

            [sty.freeBoxsize_large__l6K2SmN6Pb]: hasVariant(
              $state,
              "size",
              "large"
            ),

            [sty.freeBoxsize_small__l6K2SUcAu]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true)
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <MenuIcon
                    className={classNames(projectcss.all, sty.svg___7ZbH5)}
                    role={"img"}
                  />
                ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__qAvVa, {
            [sty.freeBoxshowEndIcon__qAvVapetz9]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),

            [sty.freeBoxsize_small__qAvVaucAu]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false)
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <MenuIcon
                    className={classNames(projectcss.all, sty.svg___7R7Eg)}
                    role={"img"}
                  />
                ),

...
import sty from "./PlasmicValue.module.css"; // plasmic-import: K_hf9-UXrWCjm3/css
import TakeOffIcon from "./icons/PlasmicIcon__TakeOff"; // plasmic-import: UC1n64xqm9U5V5/icon
...
function PlasmicValue__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__jHaVs, {
          [sty.freeBoxcenter__jHaVsK0Gpj]: hasVariant(
            $state,
            "center",
            "center"
          ),

          [sty.freeBoxtopBottom__jHaVs8WqdJ]: hasVariant(
            $state,
            "topBottom",
            "topBottom"
          )
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__lpxoq)}>
          {p.renderPlasmicSlot({
            defaultContents: (
              <TakeOffIcon
                className={classNames(projectcss.all, sty.svg___8GiKo)}
                role={"img"}
              />
            ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__cgXiw, {
          [sty.freeBoxcenter__cgXiwk0Gpj]: hasVariant(
            $state,
            "center",
            "center"
          ),

          [sty.freeBoxwithButton__cgXiwhIkow]: hasVariant(
            $state,
            "withButton",
            "withButton"
          )
      ...
      {(hasVariant($state, "withButton", "withButton") ? true : false) ? (
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__dUllz, {
            [sty.freeBoxcenter__dUllzK0Gpj]: hasVariant(
              $state,
              "center",
              "center"
            ),

            [sty.freeBoxwithButton__dUllzHIkow]: hasVariant(
              $state,
              "withButton",
              "withButton"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Button
                className={classNames("__wab_instance", sty.button__lGjKe, {
                  [sty.buttonwithButton__lGjKehIkow]: hasVariant(
                    $state,
                    "withButton",
                    "withButton"
                  )
                ...
                endIcon={
                  <RightArrowIcon
                    className={classNames(projectcss.all, sty.svg__x4E2E)}
                    role={"img"}
                  />
                }
                rounded={true}

...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 7Lc_EtX3oq7k19/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: xNJwo3LlBkE8Du/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: K61aQSkRHYiooW/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__mj23C)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__x1KA)}
                role={"img"}
              />
            ),
